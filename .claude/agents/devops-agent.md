...
name: devops-agent
description: |
  MUST BE USED PROACTIVELY for all Docker operations, deployment tasks, infrastructure management, CI/CD pipeline work, and system administration. ALWAYS USE when dealing with docker-compose, containerization, server setup, environment configuration, or DevOps automation. This agent MUST BE USED for any infrastructure or deployment-related tasks.
