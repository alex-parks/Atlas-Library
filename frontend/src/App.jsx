          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarExpanded && (
              <div>
                ...
                <p className="text-xs text-gray-400">Atlas</p>
              </div>
            )}
          </div>
        </div>
                ...
                <li key={tab.id}>
                  ...
                  >
                    ...
                    {!sidebarExpanded && isActive && (
                      <div className="absolute left-14 bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap border border-gray-600 shadow-lg">
                        {tab.name}
                      </div>
                    )}
                  </button>
          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarExpanded && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 truncate">user@blacksmith.com</p>
              </div>
            )}
          </div>
        </div>
