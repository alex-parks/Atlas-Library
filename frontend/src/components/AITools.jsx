  ...
  return (
    <div className="p-6 bg-gray-900 min-h-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400">Powered by ComfyUI - Advanced AI workflows for VFX production</p>
      </div>
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-gray-400">GPU Usage: 34%</div>
            <div className="text-gray-400">|</div>
            <div className="text-gray-400">Queue: 3 jobs</div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Extend backgrounds seamlessly using AI inpainting</p>
            ...
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Remove unwanted objects from footage</p>
            ...
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Enhance image resolution with AI upscaling</p>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Apply artistic styles to images and footage</p>
            ...
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Generate concept art and mood boards</p>
            ...
            <div className="bg-gray-700 rounded-lg p-4 hover:bg-gray-650 transition-colors cursor-pointer">
              ...
              <p className="text-gray-400 text-sm mb-3">Create seamless textures from samples</p>
